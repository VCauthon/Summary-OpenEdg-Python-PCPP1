...
Save the document to the [shop.xml](../persistance/shop.xml) file. Use UTF-8 character encoding and don't forget to add the prolog to the beginning of the file. Good luck!